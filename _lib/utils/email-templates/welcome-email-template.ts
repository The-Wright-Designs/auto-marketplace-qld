interface WelcomeAfterResetEmailData {
  loginLink: string;
  userName?: string;
}
...
export function welcomeEmailTemplate({
  loginLink,
  userName,
}: WelcomeAfterResetEmailData): string {
  return `
    <!DOCTYPE html>
    <html>
      <head>
        ...
        <title>Welcome to the Auto Marketplace QLD Dealership Portal</title>
      </head>
                ...
                <tr>
                  <td>
                    <h1 style="color: #1f2937; font-size: 32px; font-weight: bold; margin: 0 0 30px; text-align: center;">
                      Welcome to the Auto Marketplace QLD Dealership Portal
                    </h1>
                    ...
                    <p style="color: #4b5563; font-size: 16px; line-height: 26px; margin: 16px 0;">
                      Welcome to the Auto Marketplace QLD Dealership Portal! Your password has been successfully updated, and you can now access your account.
                    </p>

                    <table width="100%" cellpadding="0" cellspacing="0" style="margin: 32px 0;">
                      <tr>
                        <td align="center">
                          <a href="${loginLink}" style="background-color: #2563eb; border-radius: 8px; color: #ffffff; font-size: 16px; font-weight: bold; text-decoration: none; padding: 14px 32px; display: inline-block;">
                            Go to Login
                          </a>
                        </td>
                      </tr>
