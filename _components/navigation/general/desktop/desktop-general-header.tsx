...
import DesktopGeneralHeaderNav from "./desktop-general-header-nav";

export function DesktopGeneralHeader() {
  return (
    <div className="hidden desktop-small:flex items-center justify-between h-[120px]">
      ...
      >
        ...
        <div className="relative hidden desktop:block desktop-large:-ml-1">
          <h1 className="text-white text-paragraph desktop:text-paragraph-desktop grid gap-x-2 font-bold desktop-large:tracking-[0.030rem] desktop-large:text-[40px] desktop-large:leading-[40px] desktop-large:block">
            Auto <span className="text-yellow">Marketplace</span>{" "}
            <span className="col-span-2 text-white text-[30px] desktop-large:text-[40px]">
              QLD
            </span>
          </h1>
